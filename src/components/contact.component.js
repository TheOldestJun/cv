...
export default class Contact extends Component {
  render() {
    return (
      <div>
        <div className='card teal lighten-2 z-depth-0 mt'>
          <div className='black-text text-darken-4 pt'>
            <i className='fas fa-map-marked'></i>
            <a
              className='black-text text-darken-4'
            ...
            <a className='black-text text-darken-4' href='tel:+380675303897'>
              +38(067)530-38-97
            </a>
            <br />
